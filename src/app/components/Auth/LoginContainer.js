    ...
    return (
        <MainContainer>
            ...
            <Typography variant="subtitle1">
                Dont have an account? <Button variant="text" onClick={this.goToPage.bind(this,'signup')}>Signup now.</Button>
            </Typography>
            <PaddingContainer/>
            <FormContainer>
                <Formik
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div style={{paddingTop:'10px',display:'flex',justifyContent:'space-between'}}>
                                <FormControlLabel
                                    ...
                                    label="Remember me"
                                />
                                <Button variant="text" size="small" onClick={this.goToPage.bind(this,'forgotPassword')}>Forget Password</Button>
                            </div>
